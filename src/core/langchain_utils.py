...
from embeddings.chroma_utils import vectorstore, query_embedding_function
from retrieval.retrievers import VectorRetriever, ReRankingRetriever
...
def get_rag_chain(model: str = "gpt-4o-mini"):
    ...
    history_aware_retriever = create_history_aware_retriever(llm, final_retriever, contextualize_q_prompt)
